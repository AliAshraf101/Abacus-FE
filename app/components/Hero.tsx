...
function GridDots() {
  return (
    <>
      <div className="absolute w-2 h-2 rounded-full bg-black border border-white/40 hidden xl:block" style={{ left: '117px', top: '92px' }} />
      <div className="absolute w-2 h-2 rounded-full bg-black border border-white/40 hidden xl:block" style={{ left: '117px', top: '723px' }} />
      <div className="absolute w-2 h-2 rounded-full bg-black border border-white/40 hidden xl:block" style={{ right: '125px', top: '92px' }} />
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-wrap items-start gap-2">
        <Badge icon={<ShieldCheckIcon />} label="SOC 2 Type II Certififed" />
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col">
          <h1 className="text-[clamp(32px,5vw,48px)] font-medium leading-[1.33] tracking-[-0.04em] text-white">
            Enterprise AI Infrastructure Built
          </h1>
          <div className="flex items-center gap-2">
            <h1 className="text-[clamp(32px,5vw,48px)] font-medium leading-[1.33] tracking-[-0.04em] text-white">
              For
            </h1>
            <div className="flex items-baseline gap-1 border-b-2 border-[#645AFF]">
              <h1 className="text-[clamp(32px,5vw,48px)] font-medium leading-[1.33] tracking-[-0.04em] text-white">
                Banking
              </h1>
      ...
      <div className="flex flex-wrap items-start gap-3">
        ...
        <button className="flex items-center gap-1.5 rounded-full border border-white/60 px-5 py-2.5 text-sm font-normal leading-5 tracking-[-0.01em] text-white transition-colors hover:bg-white/10">
          Contact Sales
        </button>
      </div>
    </div>
...
function Column1() {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="w-[90px] h-[90px] flex items-center justify-center opacity-0" />
      <div className="w-[90px] h-[90px] flex items-center justify-center opacity-0" />
      <div className="w-[90px] h-[90px] flex items-center justify-center">
        <div className="w-[90px] h-[90px] rounded-full bg-white/10 blur-[20px]" />
      </div>
      <div className="w-[90px] h-[90px] flex items-center justify-center opacity-0" />
      <div className="w-[90px] h-[90px] flex items-center justify-center opacity-0" />
      <div className="w-[90px] h-[90px] flex items-center justify-center opacity-0" />
...
function Column2() {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="w-[90px] h-[90px] flex items-center justify-center opacity-0" />
      <div className="w-[90px] h-[90px] flex items-center justify-center">
        <div className="w-[90px] h-[90px] rounded-full bg-white/20 blur-[20px]" />
      </div>
      <div className="w-[90px] h-[90px] flex items-center justify-center relative">
        <div className="w-[90px] h-[90px] rounded-full bg-[#645AFF] blur-[20px]" />
      </div>
      <div className="w-[90px] h-[90px] flex items-center justify-center">
        <div className="w-[90px] h-[90px] rounded-full bg-white/30 blur-[20px]" />
      </div>
      <div className="w-[90px] h-[90px] flex items-center justify-center">
        <div className="w-[90px] h-[90px] rounded-full bg-white/10 blur-[20px]" />
      </div>
    ...
    <div className="relative bg-black">
      ...
      <div className="container mx-auto px-8 lg:px-32 xl:px-0 relative">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-0">
          <div className="pt-24 pb-16 xl:pt-32 xl:pb-48 xl:max-w-[774px]">
            <MainHeadingSection />
          </div>

          <div className="hidden xl:flex items-start justify-end pt-24 pr-8">
            <DotsPattern />
          </div>
        </div>
